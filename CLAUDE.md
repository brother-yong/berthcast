...
At the start of every session, Claude must read these three files in order before doing anything else:
...
**Location:** Singapore  
**Background:** Student, Singaporean Chinese, no business or tech experience

**Where he's at:** No clear business direction yet — still figuring it out. Needs a lot of guidance. Currently building projects to establish credibility, and wants to sell them if possible.

**Goal:** Become an entrepreneur from zero. No prior experience, no network, no established niche.
...
- Don't overwhelm him. Break things into small steps. Do one thing at a time.
...
- Full writing rules are in `About Me/writing-rules.md` — follow them for all written output.
