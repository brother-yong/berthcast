...
but staff friction):
  ...
  4. A wide company-title line above the real headers ("a regional food distributor Pte Ltd |
...
p = make_csv("a regional food distributor Pte Ltd,Inventory Report,June 2026\n"
...
p = make_csv("a regional food distributor Inventory June 2026\n"
             "Item Name,Category,Current Stock,UOM\n"
             "EDAM,CHEESE,120,KG\n")
...
p = make_csv("a regional food distributor Pte Ltd,Sales Report,June 2026\n"
...
p = make_xlsx([["a regional food distributor Pte Ltd", "Inventory Report", "June 2026"],
               _HEADERS] + _DATA)
