...
13 June 2026: a regional food distributor's sales export is a SUMMARY report — no date column,
...
_check("recognises avg_qty___month (a regional food distributor's real header)",
...
# Inventory uses LONGER names than the sales sheet (real a regional food distributor pattern).
